...
for (j in mdl_ls){
    ...
    pER <- gpER(df=prd_prpdat(dat), p=par) # prep data and calc pred
...
p1
ggsave("ER_BdCitp_Ta.pdf", plot=p1, path=savpth, width=7, height=3, cairo_pdf)
```
