...
mdlls <- c("exp-Tair", "pwr-Tair", "exp-T5", "exp-Tair_IVcov", "exp-Tair_H","exp-Tair_RH", "exp-T5_IVcov", "exp-T5_H", "exp-T5_RH","exp-T5_IVcov_RH", "exp-T5_H_RH")
...
plt_mesmod(dmdl_1$Y, predict(mdl_1), mod_label = "modelled ER", mes_label = "measured ER")
plt_resmod(dmdl_1$Y, predict(mdl_1), x_lim = c(0,10))
par(mfrow=c(1,1))
```
...
round(par_2, 3)
par(mfrow=c(1,3))
pER_T(dmdl_2, "température du sol à -5 cm (°C)")
curve(par_2$a*exp(par_2$b*x), add=T, col="blue")
plt_mesmod(dmdl_2$Y, predict(mdl_2), mod_label = "modelled ER", mes_label = "measured ER")
plt_resmod(dmdl_2$Y, predict(mdl_2), x_lim = c(0,10))
par(mfrow=c(1,1))
```
```{r, fig.height=3}
par(mfrow=c(1,4))
...
# curve(par_1$a*exp(par_1$b*x), add=T, col="blue")
plt_mesmod(dmdl_1_1$Y, predict(mdl_1_1), mod_label = "modelled ER", mes_label = "measured ER")
plt_resmod(dmdl_1_1$Y, predict(mdl_1_1), x_lim = c(0,10))
par(mfrow=c(1,1))
...
# curve(par_1$a*exp(par_1$b*x), add=T, col="blue")
plt_mesmod(dmdl_1_2$Y, predict(mdl_1_2), mod_label = "modelled ER", mes_label = "measured ER")
plt_resmod(dmdl_1_2$Y, predict(mdl_1_2), x_lim = c(0,10))
par(mfrow=c(1,1))
...
# curve(par_1$a*exp(par_1$b*x), add=T, col="blue")
plt_mesmod(dmdl_2_1$Y, predict(mdl_2_1), mod_label = "modelled ER", mes_label = "measured ER")
plt_resmod(dmdl_2_1$Y, predict(mdl_2_1), x_lim = c(0,10))
par(mfrow=c(1,1))
...
# curve(par_1$a*exp(par_1$b*x), add=T, col="blue")
plt_mesmod(dmdl_2_3$Y, predict(mdl_2_3), mod_label = "modelled ER", mes_label = "measured ER")
plt_resmod(dmdl_2_3$Y, predict(mdl_2_3), x_lim = c(0,10))
par(mfrow=c(1,1))
...
# Haut 
plt_mesmod(dmdl_1$Y, predict(mdl_1), mod_label = "RE modélisée", mes_label = "Re mesurée")
...
# Bas
plt_mesmod(dmdl_2$Y, predict(mdl_2), mod_label = "RE modélisée", mes_label = "RE mesurée")
text(x=.1, y=8.6, labels=lab21, adj=0)
