...
* GPPsat_GPP_mdlpar.csv (contains models parameters for both GPPsat and GPP)
...
for (j in mdl_list){
    ...
    # GPPsat calc
    pGPPsat <- gpGPPsat(df=prd_prpdat(dat), p=par) # prep data and calc pred
    # GPP calc
...
write.csv(allpar, file.path(outpth, "GPPsat_GPP_mdlpar.csv"), quote=F, row.names=F)
```

## Model output

### GPPsat models (quality indicator and parameter)
