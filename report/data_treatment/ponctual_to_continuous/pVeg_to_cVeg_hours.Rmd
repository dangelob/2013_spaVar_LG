...
newrow <- data.frame(p_ts=c(as.POSIXct("2013-01-01 %H:%M:%S"), as.POSIXct("2013-12-01 %H:%M:%S")), A=NA, H=0, M=NA, IVcov=c(0.15,0.2))
...
write.csv(cVegm, "../../../data/processed/pdata_to_cdata/cVeg_all_hour.csv", row.names=FALSE, quote=FALSE)
```
