...
# Export csv files
## per p7
write.csv(cPAR_p7, "../../../data/processed/pdata_to_cdata/cPAR_p7.csv", row.names=FALSE, quote=FALSE)
write.csv(mdl_p7, "../../../data/processed/pdata_to_cdata/cPAR_p7_par.csv", row.names=FALSE, quote=FALSE)
## For all p7 pooled
write.csv(cPAR_all, "../../../data/processed/pdata_to_cdata/cPAR_all.csv", row.names=FALSE, quote=FALSE)
